...
[the Java library README](https://github.com/Scythe-Engineering/EagleEye-Vision-System/blob/main/library/README.md). Only single-input operations may sit between
