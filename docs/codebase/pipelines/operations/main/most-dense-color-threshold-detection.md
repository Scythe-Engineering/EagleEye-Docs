...
It supports the same `camera_bus_id`, `target_size`, `color_ranges`, area limits, blur, and morphology settings as [Color threshold detection](./color-threshold-detection).
